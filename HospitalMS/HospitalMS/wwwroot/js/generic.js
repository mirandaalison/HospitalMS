...
function generarTabla(res) {
    ...
    for (let i = 0; i < numRegistros; i++) {
        ...
        for (let j = 0; j < propiedades.length; j++) {
            ...
            if (propiedadActual === "fechaNacimiento" && obj[propiedadActual]) {
                ...
                contenido += "<td>" + (obj[propiedadActual] !== null && obj[propiedadActual] !== undefined ? obj[propiedadActual] : "") + "</td>";
            }
        }
        ...
        if (objConfiguracionGlobal.editar == true || objConfiguracionGlobal.eliminar == true) {
            ...
            if (objConfiguracionGlobal.editar == true) {
                contenido += `<i onclick="EditarPacientes(${obj[propiedadID]})" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
    ...
    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
            ...
            if (objConfiguracionGlobal.eliminar == true) {
                contenido += `<i onclick="EliminarPacientes(${obj[propiedadID]})" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
